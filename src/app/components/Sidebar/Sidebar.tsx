  ...
  return (
    <div className="lg:flex lg:flex-col">
      <div className="lg:hidden h-16 shrink-0 flex items-center justify-around">
        <Image src="/patlogo.png" alt="Logo" width={90} height={90} />
        <div className="flex ">
          <Image
        ...
        <h1
          className={`text-3xl text-center font-bold cursor-pointer ${
            isSidebarOpen ? "pl-6" : ""
          }`}
      ...
      <div
        className={`lg:fixed lg:inset-y-0 lg:flex lg:w-72 lg:flex-col transition-all duration-300 ease-in-out mt-3 ${
          isSidebarOpen ? "ml-0" : "-ml-72"
        }`}
      >
        <div
          className={`flex grow flex-col gapy-y-5 overflow-y-auto bg-white px-6 pb-4 border-r-2 ${
            isSidebarOpen ? "" : "max-h-0 overflow-hidden"
          }`}
        >
